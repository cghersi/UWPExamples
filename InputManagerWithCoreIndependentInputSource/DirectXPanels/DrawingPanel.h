...
namespace DirectXPanels
{
	...
	// Delegate for the LTEvent event.
	[Windows::Foundation::Metadata::WebHostHidden]
	public delegate void LTEventHandler(Platform::Object^ sender, Windows::UI::Core::PointerEventArgs^ e);
...
#pragma endregion 
		...
		// Raised when pointers are detected in movement.
		event LTEventHandler^ OnLTPointerPressed;
		event LTEventHandler^ OnLTPointerMoved;
		event LTEventHandler^ OnLTPointerReleased;
		event LTEventHandler^ OnLTPointerCaptureLost;
