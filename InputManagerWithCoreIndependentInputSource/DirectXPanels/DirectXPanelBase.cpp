...
DirectXPanelBase::DirectXPanelBase() :
    ...
    m_backgroundColor(D2D1::ColorF(D2D1::ColorF::White, 0)), // Default to transparent background.
    m_alphaMode(DXGI_ALPHA_MODE_PREMULTIPLIED), // Default to ignore alpha, which can provide better performance if transparency is not required.
