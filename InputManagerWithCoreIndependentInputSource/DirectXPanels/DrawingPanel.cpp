...
{
	LogMessage("StartProcessingInput");
    ...
    auto workItemHandler = ref new WorkItemHandler([this](IAsyncAction ^)
    {
		...
		m_coreInput->PointerCaptureLost += ref new TypedEventHandler<Object^, PointerEventArgs^>(this, &DrawingPanel::OnPointerCaptureLost);
...
void DrawingPanel::OnPointerCaptureLost(Object^ sender, PointerEventArgs^ e)
{
	LogMessage("OnPointerCaptureLost");
	// Handle the PointerCaptureLost event, which will be raised on a background thread.:
	OnLTPointerCaptureLost(sender, e);   
}
...
void DrawingPanel::LogMessage(Object^ parameter)
{
