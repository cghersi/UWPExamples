...
namespace WebViewPrint
{
	public class PrintHelper
	{
		...
		public async Task ShowPrintUIAsync()
		{
			...
			{
				Console.Write("Error printing: " + e.Message + ", hr=" + e.HResult);
			}
		}
		...
		/// </summary>
		/// <param name="webPage">The page to print</param>
		public virtual void PreparePrintContent(Panel webPage)
		{
			if (firstPage == null)
			{
				firstPage = webPage;
		...
		protected virtual RichTextBlockOverflow AddOnePrintPreviewPage(RichTextBlockOverflow lastRTBOAdded, PrintPageDescription printPageDescription)
		{
			...
			RichTextBlockOverflow textLink = null;
			...
			else
			{
				...
				//page = null; // new ContinuationPage(lastRTBOAdded);
			}
